...
<center>
<body>
    <form action="User_BlockChosen.php" method="POST" onsubmit="return confirm('Are you sure to block this user?')">
    ...
    {
        $queryview = "SELECT * From USER WHERE Status = 'Active' AND User_Type = 'user'";
...
?>
<br>
<input type="submit" value="Block this user">
